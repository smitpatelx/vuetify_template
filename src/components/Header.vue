  ...
  <v-layout wrap class="pr-0">
    <v-toolbar app class="pr-0">
      <v-toolbar-title class="headline text-uppercase">
        <span>AXIOS</span>
        <span class="font-weight-light subheading pl-2 hidden-sm-and-down">JS RUNTIME</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn
          flat
          href="https://github.com/smitpatelx/vuetify_template/tree/vue-todo"
          target="blank"
        >
    ...
    >
      <v-list class="pa-1">
        <v-list-tile avatar>
          <v-list-tile-avatar>
            <v-icon class="fab fa-autoprefixer"></v-icon>
          </v-list-tile-avatar>
  ...
  data() {
    return {
      ...
      items: [
        ...
        { title: "About", icon: "question_answer", router: "/about" },
        { title: "ToDo", icon: "assignment_turned_in", router: "/todo" }
      ]
    };
  }
};
